...
type AccountInvoiceLine struct {
	...
	AssetEndDate        *Time      `xmlrpc:"asset_end_date,omptempty"`
	AssetMrr            *Float     `xmlrpc:"asset_mrr,omptempty"`
	AssetStartDate      *Time      `xmlrpc:"asset_start_date,omptempty"`
...
func (c *Client) FindAccountInvoiceLine(criteria *Criteria) (*AccountInvoiceLine, error) {
	...
	return nil, fmt.Errorf("account.invoice.line was not found")
}
